    ...
    render() {
        ...
        return (
            <View style={{ height: 280, width: 320, marginLeft: 20, borderColor: '#dddddd', borderRadius: 10, alignItems: 'center', shadowColor:"black"
                ...
                <Text style={{ fontSize: 14, color:'white' }}>tomato</Text>
                </View>
                <HTML style={{ 
                    zIndex: 1, 
                    borderRadius: 10,
                    borderWidth: 2,
                    borderColor: '#dddddd'
                   }} html={`<iframe width="320" height="170"  src="https://www.youtube.com/embed/ysbeEQWXbA8?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=https://youtubeembedcode.com"></iframe>
                `} />
